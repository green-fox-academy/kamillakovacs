const picture = [
  ...
  { URL: './giphy.gif', name: 'Dave Chappelle', quote: '"I think every group of brothers should have at least one white guy in it, for safety. Because when the shit goes down, somebody is gonna need to talk to the police."'},
  { URL: './louis-ck-black-and-white-mic-comeback.png', name: 'Louis C.K.', quote: '"If you are a woman and a guy has ever said anything romantic to you, he just left off the second part that would have made you sick if you could have heard it."'},
];
